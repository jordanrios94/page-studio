...
(function() {
    ...
    function runInContext(context) {
        ...
        var iteratorTemplate = function(obj) {
            ...
            var conditions = [];
            if (support.enumPrototypes) {
                conditions.push('!(skipProto && key == \'prototype\')');
            }
            if (support.enumErrorProps) {
                conditions.push('!(skipErrorProps && (key == \'message\' || key == \'name\'))');
            }
            __p += '\nfor (var key in object) {\n';
            if (obj.useHas) {
                conditions.push('hasOwnProperty.call(object, key)');
            }
        ...
        function contains(collection, target, fromIndex) {
            ...
            if (typeof length == 'number') {
                ...
                if (typeof collection == 'string' || !isArray(collection) && isString(collection)) {
                    return nativeContains ? nativeContains.call(collection, target, fromIndex) : collection.indexOf(target, fromIndex) > -1;
                }
        ...
        function sortBy(collection, callback, thisArg) {
            ...
            forEach(collection, function(value, key, collection) {
                ...
                object.index = index;
                object.value = value;
                object.criteria = multi ? map(callback, function(key) {
                    return value[key];
        ...
        if (!nativeTrim || nativeTrim.call(whitespace)) {
            trim = function(string) {
                ...
                return string ? string.slice(trimmedLeftIndex(string), trimmedRightIndex(string) + 1) : string;
            };
        }
        ...
        if (!nativeTrimLeft || nativeTrimLeft.call(whitespace)) {
            trimLeft = function(string) {
                string = string == null ? '' : String(string);
                return string ? string.slice(trimmedLeftIndex(string)) : string;
            };
        }
        ...
        if (!nativeTrimRight || nativeTrimRight.call(whitespace)) {
            trimRight = function(string) {
                string = string == null ? '' : String(string);
                return string ? string.slice(0, trimmedRightIndex(string) + 1) : string;
            };
        }
